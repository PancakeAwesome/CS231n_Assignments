...
# 测试 the affine_backward function
...
acc = np.mean(data['y_test'] == y_pred)
...
# 将sgd + momentum 运用到一个六层的网络上，你就会发现这种方法比朴素版的sgd要收敛的更快
num_train = 4000
small_data = {
  'X_train': data['X_train'][:num_train],
  'y_train': data['y_train'][:num_train],
